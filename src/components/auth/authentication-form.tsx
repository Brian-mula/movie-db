          ...
          </p>
        {
            pageType === "register" && (
                ...
                <input
                  ...
                  className={`shadow appearance-none border ${
                    usernameError ? "border-red-500" : "border-accent"
                  }  w-full py-3 rounded-lg px-3 text-dark leading-tight focus:outline-none focus:shadow-outline`}
                  id="username"
                  type="text"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`shadow appearance-none border ${
                emailError ? "border-red-500" : "border-accent"
              }  w-full py-3 rounded-lg px-3 text-dark leading-tight focus:outline-none focus:shadow-outline`}
              id="email"
              type="email"
          ...
          <div className="mb-6">
            ...
            >
              <input
                ...
                className=" appearance-none  rounded w-[96%] py-3 h-full flex-grow px-3 text-dark  leading-tight focus:outline-none focus:shadow-outline "
                id="password"
          ...
          <button
              ...
              >
                <span>🔒</span>
                <span>{ pageType == 'login' ? 'Sign In Securely': 'Sign Up Securely'}</span>
              </button>
          </div>
          ...
          <Link
            ...
            >
             {pageType === 'login' ? " Don't have an account?" : "Already have an account"} <span className="text-accent">{ pageType === 'login' ? "Register here":"Login here"}</span>
            </Link>
